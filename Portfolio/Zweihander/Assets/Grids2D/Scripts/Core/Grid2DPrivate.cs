...
namespace Grids2D
{
	...
	public partial class Grid2D : MonoBehaviour
	{
		...
		const double MIN_VERTEX_DISTANCE = 0.001;
...
//			Geom.Polygon surfacedPolygon = connector.ToPolygonFromLargestLineStrip ();
		...
		{
			return GenerateTerritoryRegionSurface (territoryIndex, material, textureScale, textureOffset, textureRotation, false);
		}
		...
		{
			return GenerateCellRegionSurface (cellIndex, material, textureScale, textureOffset, textureRotation, false);
		}
